        ...
        'tests': [
            {
                ...
                # ],
                'inferTrue': [
                    'HeadingNorth2 >> ~HeadingSouth2', 'HeadingNorth2 >> ~HeadingEast2', 'HeadingNorth2 >> HeadingNorth2', 'HeadingNorth2 >> ~HeadingEast2', 'HeadingNorth2 | HeadingWest2 | HeadingEast2 | HeadingSouth2'
                ],
                'inferFalse': [
                    'HeadingNorth2 >> HeadingWest0', '~HeadingWest0', '~HeadingNorth0', 'HeadingNorth0',
                    'HeadingNorth1', '~HeadingEast1', 'HeadingNorth2 >> HeadingNorth3', '~HeadingNorth3'
                ]
            }
        ],
        'score': 1
